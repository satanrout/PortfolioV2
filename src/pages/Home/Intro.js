          ...
          <Fragment>
            <IntroText>
              <IntroName status={status} id={titleId}>
                <DecoderText text="Ritesh Bucha" start={!prerender} offset={120} />
              </IntroName>
              <IntroTitle>
                <IntroTitleLabel>{`Web Developer + ${introLabel}`}</IntroTitleLabel>
                <IntroTitleRow aria-hidden prerender={prerender}>
                  <IntroTitleWord status={status} delay={tokens.base.durationXS}>Web Developer</IntroTitleWord>
